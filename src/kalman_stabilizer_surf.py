...
surf = cv2.cv2.xfeatures2d.SURF_create()
...
for k in range(N_FRAMES-1):
    ...
    frame.features = surf.detect(frame.img_gray,None)
...
print "------------------------------------------------------------------------------"
print "Quantidade media de pontos detectados por surf foi de", str(percent) + " " + "pontos"
...
fim = time.time()
print "Tempo de execucao total, SURF: ", str(fim-ini) + " " + "segundos"
print "------------------------------------------------------------------------------"
############# medicoes ##########################
