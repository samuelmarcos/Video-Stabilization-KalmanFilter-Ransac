...
videoInPath = "../data/Cebu_Earthquake_2013_Caught_on_CCTV_Camera_2 _(online-video-cutter.com).mp4"
...
for k in range(N_FRAMES-1):
    ...
    print("quant",len(frame.features))
...
print "------------------------------------------------------------------------------"
print "Quantidade media de pontos detectados por sift foi de", str(percent) + " " + "pontos"
...
fim = time.time()
print "Tempo de execucao total, SIFT: ", str(fim-ini) + " " + "segundos"
print "------------------------------------------------------------------------------"
