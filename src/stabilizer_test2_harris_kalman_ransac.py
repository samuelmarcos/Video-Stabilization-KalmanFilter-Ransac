...
video_path = "../data/ONROAD_original.avi"
...
#orb_params = dict(edgeThreshold=15, patchSize=31, nlevels=8, fastThreshold=20, scaleFactor=1.2, WTA_K=2,scoreType=cv2.ORB_HARRIS_SCORE, firstLevel=0, nfeatures=500)
...
for k in range(N_FRAMES-1):
    ...
    #frame.features,_= sift.detectAndCompute(frame_img_gray,None)
