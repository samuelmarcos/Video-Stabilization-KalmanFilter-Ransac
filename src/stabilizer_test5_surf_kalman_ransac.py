...
surf_params = dict(hessianThreshold=500, upright=True, extended=True)

surf = cv2.cv2.xfeatures2d.SURF_create(**surf_params)
...
for k in range(N_FRAMES-1):
    ...
    feature_time_ini = time.time()
    frame.features = surf.detect(frame_img_gray,None)
